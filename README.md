...
[![Skills](https://img.shields.io/badge/Skills-23-green.svg)](#可用技能)
...
| # | 模式 | 来源 | 核心思想 |
|---|------|------|----------|
| 1 | 分类本能 | Bezos | 按可逆性 × 影响量级分类（单向门/双向门） |
| 2 | 反转反射 | Munger | 每个"如何赢"都要问"什么会让我们失败？" |
| 3 | 速度校准 | Bezos | 默认快速；只对不可逆+高影响决策放慢 |
| 4 | 勇气累积 | — | 信心来自做出艰难决策之后，而非之前 |
| 5 | 聚焦即减法 | Jobs | 价值 = 决定什么不做（350 → 10） |
| 6 | 代理指标怀疑 | Bezos | 指标还在服务用户，还是已自我循环？ |
| 7 | 杠杆执念 | Altman | 找到小投入产生巨大产出的支点 |
| 8 | 意志力即战略 | Altman | 世界会对足够持久的执拗让步 |
| 9 | 人员优先排序 | Horowitz | 人、产品、利润——永远按这个顺序 |
| 10 | 叙事连贯性 | — | 艰难决策需要清晰框架，让"为什么"可见 |
| 11 | 战时意识 | Horowitz | 和平时期 ≠ 战争时期——调整领导风格 |
| 12 | 创始人模式偏好 | Chesky/Graham | 深度参与不等于微管理，如果它扩展了团队思考 |
| 13 | 层级即服务 | Rams | 用户应该先看到什么、再看到什么？ |
| 14 | 减法默认 | Rams | "尽可能少的设计"——挣不到像素就砍掉 |
| 15 | 边界条件偏执 | — | 47 字符？零结果？网络中断？空状态就是功能 |
| 16 | 信任设计 | — | 每个界面决策要么建立信任，要么侵蚀信任 |
| 17 | 偏执扫描 | Grove | 持续扫描拐点、文化漂移、流程变代理病 |
| 18 | 时间纵深 | Bezos | 以 5-10 年弧度思考，遗憾最小化框架 |
